...
* Fingerprint generated out of host id and name.
* Pseudo random (`Math.random()` in Java)
...
* [cuid for JavaScript](https://github.com/ericelliott/cuid) - [Eric Elliott](https://github.com/ericelliott) 
